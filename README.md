...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tv9yfn0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tv9yfn0.containers.anotherwebservice.com/
...
```
git clone git@github.com:Monjur203/container-tv9yfn0.git
cd container-tv9yfn0
```
...
```
docker attach container-tv9yfn0
```
